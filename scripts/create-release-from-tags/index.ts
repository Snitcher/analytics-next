 ...
 * @example ["@snitcher/analytics-core@1.0.0", "@snitcher/analytics-browser@2.1.1"]
 */
...
/**
 *
 * @param rawTags - string delimited list of tags (e.g. `@snitcher/analytics-browser@2.1.1 @snitcher/analytics-core@1.0.0`)
 */
